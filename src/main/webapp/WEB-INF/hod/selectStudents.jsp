...
<div class="container">
	<div class="row">
		<div class="col-md-6 border border-info">
			<form role="form"  action="${pageContext.request.contextPath}/hod/student/view" method="get"> 
		...
		<div class="col-md-6 border border-info">
			<form role="form" action="${pageContext.request.contextPath}/hod/student/viewAlumini" method="get" > 
